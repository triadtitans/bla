...
/* singlecomplex */ VOID cdotc_(singlecomplex * ret_val, integer *n, singlecomplex *cx, integer 
				*incx, singlecomplex *cy, integer *incy);

/* singlecomplex */ VOID cdotu_(singlecomplex * ret_val, integer *n, singlecomplex *cx, integer 
				*incx, singlecomplex *cy, integer *incy);
...
/* Subroutine */ int chbmv_(char *uplo, integer *n, integer *k, singlecomplex *
			    alpha, singlecomplex *a, integer *lda, singlecomplex *x, integer *incx, singlecomplex *
			    beta, singlecomplex *y, integer *incy);
...
/* Subroutine */ int chpmv_(char *uplo, integer *n, singlecomplex *alpha, singlecomplex *
...
/* Subroutine */ int chpr2_(char *uplo, integer *n, singlecomplex *alpha, singlecomplex *
...
/* Subroutine */ int cbdsqr_(char *uplo, integer *n, integer *ncvt, integer *
			     nru, integer *ncc, real *d__, real *e, singlecomplex *vt, integer *ldvt, 
...
/* Subroutine */ int cgbequ_(integer *m, integer *n, integer *kl, integer *ku, 
			     singlecomplex *ab, integer *ldab, real *r__, real *c__, real *rowcnd, real 
			     *colcnd, real *amax, integer *info);

/* Subroutine */ int cgbequb_(integer *m, integer *n, integer *kl, integer *
			      ku, singlecomplex *ab, integer *ldab, real *r__, real *c__, real *rowcnd, 
			      real *colcnd, real *amax, integer *info);

/* Subroutine */ int cgbrfs_(char *trans, integer *n, integer *kl, integer *
			     ku, integer *nrhs, singlecomplex *ab, integer *ldab, singlecomplex *afb, integer *
			     ldafb, integer *ipiv, singlecomplex *b, integer *ldb, singlecomplex *x, integer *
			     ldx, real *ferr, real *berr, singlecomplex *work, real *rwork, integer *
			     info);

/* Subroutine */ int cgbrfsx_(char *trans, char *equed, integer *n, integer *
			      kl, integer *ku, integer *nrhs, singlecomplex *ab, integer *ldab, singlecomplex *
			      afb, integer *ldafb, integer *ipiv, real *r__, real *c__, singlecomplex *b, 
			      ...
			      integer *nparams, real *params, singlecomplex *work, real *rwork, integer *
			      info);

/* Subroutine */ int cgbsv_(integer *n, integer *kl, integer *ku, integer *
			    nrhs, singlecomplex *ab, integer *ldab, integer *ipiv, singlecomplex *b, integer *
			    ldb, integer *info);
...
/* Subroutine */ int cgbsvx_(char *fact, char *trans, integer *n, integer *kl, 
			     ...
			     singlecomplex *b, integer *ldb, singlecomplex *x, integer *ldx, real *rcond, real 
			     *ferr, real *berr, singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int cgbsvxx_(char *fact, char *trans, integer *n, integer *
			      ...
			      params, singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int cgbtrs_(char *trans, integer *n, integer *kl, integer *
			     ku, integer *nrhs, singlecomplex *ab, integer *ldab, integer *ipiv, singlecomplex 
...
/* Subroutine */ int cgeequb_(integer *m, integer *n, singlecomplex *a, integer *
...
/* Subroutine */ int cgees_(char *jobvs, char *sort, L_fp select, integer *n, 
			    ...
			    integer *ldvs, singlecomplex *work, integer *lwork, real *rwork, logical *
			    bwork, integer *info);

/* Subroutine */ int cgeesx_(char *jobvs, char *sort, L_fp select, char *
			     sense, integer *n, singlecomplex *a, integer *lda, integer *sdim, singlecomplex *
			     w, singlecomplex *vs, integer *ldvs, real *rconde, real *rcondv, singlecomplex *
...
/* Subroutine */ int cgeevx_(char *balanc, char *jobvl, char *jobvr, char *
			     sense, integer *n, singlecomplex *a, integer *lda, singlecomplex *w, singlecomplex *vl, 
...
/* Subroutine */ int cgegs_(char *jobvsl, char *jobvsr, integer *n, singlecomplex *
			    a, integer *lda, singlecomplex *b, integer *ldb, singlecomplex *alpha, singlecomplex *
			    beta, singlecomplex *vsl, integer *ldvsl, singlecomplex *vsr, integer *ldvsr, 
...
/* Subroutine */ int cgegv_(char *jobvl, char *jobvr, integer *n, singlecomplex *a, 
			    ...
			    singlecomplex *vl, integer *ldvl, singlecomplex *vr, integer *ldvr, singlecomplex *
...
/* Subroutine */ int cgels_(char *trans, integer *m, integer *n, integer *
			    nrhs, singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, singlecomplex *
...
/* Subroutine */ int cgelss_(integer *m, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, singlecomplex *b, integer *ldb, real *s, real *rcond, 
			     integer *rank, singlecomplex *work, integer *lwork, real *rwork, integer *
			     info);

/* Subroutine */ int cgelsx_(integer *m, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, singlecomplex *b, integer *ldb, integer *jpvt, real *rcond, 
			     integer *rank, singlecomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgelsy_(integer *m, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, singlecomplex *b, integer *ldb, integer *jpvt, real *rcond, 
			     integer *rank, singlecomplex *work, integer *lwork, real *rwork, integer *
			     info);
...
/* Subroutine */ int cgeqp3_(integer *m, integer *n, singlecomplex *a, integer *lda, 
			     integer *jpvt, singlecomplex *tau, singlecomplex *work, integer *lwork, real *
			     rwork, integer *info);

/* Subroutine */ int cgeqpf_(integer *m, integer *n, singlecomplex *a, integer *lda, 
			     integer *jpvt, singlecomplex *tau, singlecomplex *work, real *rwork, integer *
			     info);
...
/* Subroutine */ int cgerfs_(char *trans, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, singlecomplex *af, integer *ldaf, integer *ipiv, singlecomplex *
			     b, integer *ldb, singlecomplex *x, integer *ldx, real *ferr, real *berr, 
			     singlecomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgerfsx_(char *trans, char *equed, integer *n, integer *
			      nrhs, singlecomplex *a, integer *lda, singlecomplex *af, integer *ldaf, integer *
			      ipiv, real *r__, real *c__, singlecomplex *b, integer *ldb, singlecomplex *x, 
...
/* Subroutine */ int cgesc2_(integer *n, singlecomplex *a, integer *lda, singlecomplex *
...
/* Subroutine */ int cgesvd_(char *jobu, char *jobvt, integer *m, integer *n, 
			     singlecomplex *a, integer *lda, real *s, singlecomplex *u, integer *ldu, singlecomplex *
			     vt, integer *ldvt, singlecomplex *work, integer *lwork, real *rwork, 
			     integer *info);

/* Subroutine */ int cgesvx_(char *fact, char *trans, integer *n, integer *
			     nrhs, singlecomplex *a, integer *lda, singlecomplex *af, integer *ldaf, integer *
			     ipiv, char *equed, real *r__, real *c__, singlecomplex *b, integer *ldb, 
...
/* Subroutine */ int cgetc2_(integer *n, singlecomplex *a, integer *lda, integer *
...
/* Subroutine */ int cgetri_(integer *n, singlecomplex *a, integer *lda, integer *
			     ipiv, singlecomplex *work, integer *lwork, integer *info);
...
/* Subroutine */ int cgges_(char *jobvsl, char *jobvsr, char *sort, L_fp 
			    selctg, integer *n, singlecomplex *a, integer *lda, singlecomplex *b, integer *
			    ldb, integer *sdim, singlecomplex *alpha, singlecomplex *beta, singlecomplex *vsl, 
			    integer *ldvsl, singlecomplex *vsr, integer *ldvsr, singlecomplex *work, integer *
			    lwork, real *rwork, logical *bwork, integer *info);

/* Subroutine */ int cggesx_(char *jobvsl, char *jobvsr, char *sort, L_fp 
			     selctg, char *sense, integer *n, singlecomplex *a, integer *lda, singlecomplex *b, 
			     integer *ldb, integer *sdim, singlecomplex *alpha, singlecomplex *beta, singlecomplex *
			     vsl, integer *ldvsl, singlecomplex *vsr, integer *ldvsr, real *rconde, real 
			     *rcondv, singlecomplex *work, integer *lwork, real *rwork, integer *iwork, 
...
/* Subroutine */ int cggevx_(char *balanc, char *jobvl, char *jobvr, char *
			     sense, integer *n, singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, 
			     singlecomplex *alpha, singlecomplex *beta, singlecomplex *vl, integer *ldvl, singlecomplex *
			     vr, integer *ldvr, integer *ilo, integer *ihi, real *lscale, real *
			     rscale, real *abnrm, real *bbnrm, real *rconde, real *rcondv, singlecomplex 
...
/* Subroutine */ int cgghrd_(char *compq, char *compz, integer *n, integer *
			     ilo, integer *ihi, singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, 
...
/* Subroutine */ int cggsvd_(char *jobu, char *jobv, char *jobq, integer *m, 
			     integer *n, integer *p, integer *k, integer *l, singlecomplex *a, integer *
			     lda, singlecomplex *b, integer *ldb, real *alpha, real *beta, singlecomplex *u, 
...
/* Subroutine */ int cggsvp_(char *jobu, char *jobv, char *jobq, integer *m, 
			     integer *p, integer *n, singlecomplex *a, integer *lda, singlecomplex *b, integer 
			     *ldb, real *tola, real *tolb, integer *k, integer *l, singlecomplex *u, 
			     integer *ldu, singlecomplex *v, integer *ldv, singlecomplex *q, integer *ldq, 
			     integer *iwork, real *rwork, singlecomplex *tau, singlecomplex *work, integer *
			     info);

/* Subroutine */ int cgtcon_(char *norm, integer *n, singlecomplex *dl, singlecomplex *
			     d__, singlecomplex *du, singlecomplex *du2, integer *ipiv, real *anorm, real *
			     rcond, singlecomplex *work, integer *info);

/* Subroutine */ int cgtrfs_(char *trans, integer *n, integer *nrhs, singlecomplex *
			     dl, singlecomplex *d__, singlecomplex *du, singlecomplex *dlf, singlecomplex *df, singlecomplex *
			     duf, singlecomplex *du2, integer *ipiv, singlecomplex *b, integer *ldb, singlecomplex *
			     x, integer *ldx, real *ferr, real *berr, singlecomplex *work, real *rwork, 
			     integer *info);

/* Subroutine */ int cgtsv_(integer *n, integer *nrhs, singlecomplex *dl, singlecomplex *
			    d__, singlecomplex *du, singlecomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cgtsvx_(char *fact, char *trans, integer *n, integer *
			     nrhs, singlecomplex *dl, singlecomplex *d__, singlecomplex *du, singlecomplex *dlf, singlecomplex *
			     df, singlecomplex *duf, singlecomplex *du2, integer *ipiv, singlecomplex *b, integer *
			     ldb, singlecomplex *x, integer *ldx, real *rcond, real *ferr, real *berr, 
			     singlecomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgttrf_(integer *n, singlecomplex *dl, singlecomplex *d__, singlecomplex *
			     du, singlecomplex *du2, integer *ipiv, integer *info);

/* Subroutine */ int cgttrs_(char *trans, integer *n, integer *nrhs, singlecomplex *
			     dl, singlecomplex *d__, singlecomplex *du, singlecomplex *du2, integer *ipiv, singlecomplex *
			     b, integer *ldb, integer *info);
...
/* Subroutine */ int chbevd_(char *jobz, char *uplo, integer *n, integer *kd, 
			     singlecomplex *ab, integer *ldab, real *w, singlecomplex *z__, integer *ldz, 
			     singlecomplex *work, integer *lwork, real *rwork, integer *lrwork, integer *
...
/* Subroutine */ int chbevx_(char *jobz, char *range, char *uplo, integer *n, 
			     ...
			     m, real *w, singlecomplex *z__, integer *ldz, singlecomplex *work, real *rwork, 
...
/* Subroutine */ int chbgvx_(char *jobz, char *range, char *uplo, integer *n, 
			     ...
			     integer *ldbb, singlecomplex *q, integer *ldq, real *vl, real *vu, integer *
			     il, integer *iu, real *abstol, integer *m, real *w, singlecomplex *z__, 
			     integer *ldz, singlecomplex *work, real *rwork, integer *iwork, integer *
			     ifail, integer *info);

/* Subroutine */ int chbtrd_(char *vect, char *uplo, integer *n, integer *kd, 
			     singlecomplex *ab, integer *ldab, real *d__, real *e, singlecomplex *q, integer *
			     ldq, singlecomplex *work, integer *info);

/* Subroutine */ int checon_(char *uplo, integer *n, singlecomplex *a, integer *lda, 
			     integer *ipiv, real *anorm, real *rcond, singlecomplex *work, integer *
			     info);

/* Subroutine */ int cheequb_(char *uplo, integer *n, singlecomplex *a, integer *
			      lda, real *s, real *scond, real *amax, singlecomplex *work, integer *info);
...
/* Subroutine */ int cheevr_(char *jobz, char *range, char *uplo, integer *n, 
			     singlecomplex *a, integer *lda, real *vl, real *vu, integer *il, integer *
			     iu, real *abstol, integer *m, real *w, singlecomplex *z__, integer *ldz, 
			     integer *isuppz, singlecomplex *work, integer *lwork, real *rwork, integer *
			     lrwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int cheevx_(char *jobz, char *range, char *uplo, integer *n, 
			     singlecomplex *a, integer *lda, real *vl, real *vu, integer *il, integer *
			     iu, real *abstol, integer *m, real *w, singlecomplex *z__, integer *ldz, 
			     singlecomplex *work, integer *lwork, real *rwork, integer *iwork, integer *
			     ifail, integer *info);

/* Subroutine */ int chegs2_(integer *itype, char *uplo, integer *n, singlecomplex *
			     a, integer *lda, singlecomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chegst_(integer *itype, char *uplo, integer *n, singlecomplex *
			     a, integer *lda, singlecomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chegv_(integer *itype, char *jobz, char *uplo, integer *
			    n, singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, real *w, 
			    singlecomplex *work, integer *lwork, real *rwork, integer *info);
...
/* Subroutine */ int chegvx_(integer *itype, char *jobz, char *range, char *
			     uplo, integer *n, singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, 
			     real *vl, real *vu, integer *il, integer *iu, real *abstol, integer *
			     m, real *w, singlecomplex *z__, integer *ldz, singlecomplex *work, integer *lwork, 
			     real *rwork, integer *iwork, integer *ifail, integer *info);

/* Subroutine */ int cherfs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, singlecomplex *af, integer *ldaf, integer *ipiv, singlecomplex *
			     b, integer *ldb, singlecomplex *x, integer *ldx, real *ferr, real *berr, 
			     singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int cherfsx_(char *uplo, char *equed, integer *n, integer *
			      nrhs, singlecomplex *a, integer *lda, singlecomplex *af, integer *ldaf, integer *
			      ipiv, real *s, singlecomplex *b, integer *ldb, singlecomplex *x, integer *ldx, 
...
/* Subroutine */ int chesvx_(char *fact, char *uplo, integer *n, integer *
			     nrhs, singlecomplex *a, integer *lda, singlecomplex *af, integer *ldaf, integer *
			     ipiv, singlecomplex *b, integer *ldb, singlecomplex *x, integer *ldx, real *rcond, 
...
/* Subroutine */ int chesvxx_(char *fact, char *uplo, integer *n, integer *
			      nrhs, singlecomplex *a, integer *lda, singlecomplex *af, integer *ldaf, integer *
			      ipiv, char *equed, real *s, singlecomplex *b, integer *ldb, singlecomplex *x, 
			      integer *ldx, real *rcond, real *rpvgrw, real *berr, integer *
			      n_err_bnds__, real *err_bnds_norm__, real *err_bnds_comp__, integer *
			      nparams, real *params, singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int chetrs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, integer *ipiv, singlecomplex *b, integer *ldb, integer *
			     info);
...
/* Subroutine */ int chpcon_(char *uplo, integer *n, singlecomplex *ap, integer *
			     ipiv, real *anorm, real *rcond, singlecomplex *work, integer *info);
...
/* Subroutine */ int chpevx_(char *jobz, char *range, char *uplo, integer *n, 
			     singlecomplex *ap, real *vl, real *vu, integer *il, integer *iu, real *
			     abstol, integer *m, real *w, singlecomplex *z__, integer *ldz, singlecomplex *
			     work, real *rwork, integer *iwork, integer *ifail, integer *info);

/* Subroutine */ int chpgst_(integer *itype, char *uplo, integer *n, singlecomplex *
			     ap, singlecomplex *bp, integer *info);

/* Subroutine */ int chpgv_(integer *itype, char *jobz, char *uplo, integer *
			    n, singlecomplex *ap, singlecomplex *bp, real *w, singlecomplex *z__, integer *ldz, 
			    singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int chpgvx_(integer *itype, char *jobz, char *range, char *
			     uplo, integer *n, singlecomplex *ap, singlecomplex *bp, real *vl, real *vu, 
			     integer *il, integer *iu, real *abstol, integer *m, real *w, singlecomplex *
			     z__, integer *ldz, singlecomplex *work, real *rwork, integer *iwork, 
			     integer *ifail, integer *info);

/* Subroutine */ int chprfs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     ap, singlecomplex *afp, integer *ipiv, singlecomplex *b, integer *ldb, singlecomplex *x, 
			     integer *ldx, real *ferr, real *berr, singlecomplex *work, real *rwork, 
			     integer *info);

/* Subroutine */ int chpsv_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			    ap, integer *ipiv, singlecomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chpsvx_(char *fact, char *uplo, integer *n, integer *
			     nrhs, singlecomplex *ap, singlecomplex *afp, integer *ipiv, singlecomplex *b, integer *
			     ldb, singlecomplex *x, integer *ldx, real *rcond, real *ferr, real *berr, 
			     singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int chptrf_(char *uplo, integer *n, singlecomplex *ap, integer *
			     ipiv, integer *info);

/* Subroutine */ int chptri_(char *uplo, integer *n, singlecomplex *ap, integer *
			     ipiv, singlecomplex *work, integer *info);

/* Subroutine */ int chptrs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     ap, integer *ipiv, singlecomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chsein_(char *side, char *eigsrc, char *initv, logical *
			     select, integer *n, singlecomplex *h__, integer *ldh, singlecomplex *w, singlecomplex *
			     vl, integer *ldvl, singlecomplex *vr, integer *ldvr, integer *mm, integer *
			     m, singlecomplex *work, real *rwork, integer *ifaill, integer *ifailr, 
			     integer *info);
...
doublereal cla_gbrcond_c__(char *trans, integer *n, integer *kl, integer *ku, 
			   singlecomplex *ab, integer *ldab, singlecomplex *afb, integer *ldafb, integer *
			   ipiv, real *c__, logical *capply, integer *info, singlecomplex *work, real *
			   rwork, ftnlen trans_len);

doublereal cla_gbrcond_x__(char *trans, integer *n, integer *kl, integer *ku, 
			   singlecomplex *ab, integer *ldab, singlecomplex *afb, integer *ldafb, integer *
			   ipiv, singlecomplex *x, integer *info, singlecomplex *work, real *rwork, ftnlen 
			   trans_len);
...
/* Subroutine */ int cla_gbrfsx_extended__(integer *prec_type__, integer *
					   ...
					   singlecomplex *ab, integer *ldab, singlecomplex *afb, integer *ldafb, integer *
					   ipiv, logical *colequ, real *c__, singlecomplex *b, integer *ldb, singlecomplex *
					   y, integer *ldy, real *berr_out__, integer *n_norms__, real *errs_n__,
					   real *errs_c__, singlecomplex *res, real *ayb, singlecomplex *dy, singlecomplex *
...
doublereal cla_gbrpvgrw__(integer *n, integer *kl, integer *ku, integer *
			  ncols, singlecomplex *ab, integer *ldab, singlecomplex *afb, integer *ldafb);

/* Subroutine */ int cla_geamv__(integer *trans, integer *m, integer *n, real 
				 *alpha, singlecomplex *a, integer *lda, singlecomplex *x, integer *incx, real *
...
/* Subroutine */ int cla_gerfsx_extended__(integer *prec_type__, integer *
					   trans_type__, integer *n, integer *nrhs, singlecomplex *a, integer *lda, 
					   ...
					   real *ayb, singlecomplex *dy, singlecomplex *y_tail__, real *rcond, integer *
					   ithresh, real *rthresh, real *dz_ub__, logical *ignore_cwise__, 
					   integer *info);

/* Subroutine */ int cla_heamv__(integer *uplo, integer *n, real *alpha, 
				 singlecomplex *a, integer *lda, singlecomplex *x, integer *incx, real *beta, real 
				 *y, integer *incy);
...
/* Subroutine */ int cla_herfsx_extended__(integer *prec_type__, char *uplo, 
					   ...
					   integer *ldb, singlecomplex *y, integer *ldy, real *berr_out__, integer *
					   n_norms__, real *errs_n__, real *errs_c__, singlecomplex *res, real *ayb, 
					   singlecomplex *dy, singlecomplex *y_tail__, real *rcond, integer *ithresh, real *
...
/* Subroutine */ int cla_porfsx_extended__(integer *prec_type__, char *uplo, 
					   ...
					   singlecomplex *y, integer *ldy, real *berr_out__, integer *n_norms__, real *
					   errs_n__, real *errs_c__, singlecomplex *res, real *ayb, singlecomplex *dy, 
					   singlecomplex *y_tail__, real *rcond, integer *ithresh, real *rthresh, real 
					   *dz_ub__, logical *ignore_cwise__, integer *info, ftnlen uplo_len);

doublereal cla_porpvgrw__(char *uplo, integer *ncols, singlecomplex *a, integer *
			  lda, singlecomplex *af, integer *ldaf, real *work, ftnlen uplo_len);
...
/* Subroutine */ int cla_wwaddw__(integer *n, singlecomplex *x, singlecomplex *y, singlecomplex 
				  *w);
...
/* Subroutine */ int clacrt_(integer *n, singlecomplex *cx, integer *incx, singlecomplex *
			     cy, integer *incy, singlecomplex *c__, singlecomplex *s);
...
/* Subroutine */ int claesy_(singlecomplex *a, singlecomplex *b, singlecomplex *c__, singlecomplex *
			     rt1, singlecomplex *rt2, singlecomplex *evscal, singlecomplex *cs1, singlecomplex *sn1);

/* Subroutine */ int claev2_(singlecomplex *a, singlecomplex *b, singlecomplex *c__, real *rt1, 
			     real *rt2, real *cs1, singlecomplex *sn1);

/* Subroutine */ int clag2z_(integer *m, integer *n, singlecomplex *sa, integer *
...
/* Subroutine */ int clagtm_(char *trans, integer *n, integer *nrhs, real *
			     alpha, singlecomplex *dl, singlecomplex *d__, singlecomplex *du, singlecomplex *x, integer *
			     ldx, real *beta, singlecomplex *b, integer *ldb);
...
doublereal clangb_(char *norm, integer *n, integer *kl, integer *ku, singlecomplex *
		   ab, integer *ldab, real *work);

doublereal clange_(char *norm, integer *m, integer *n, singlecomplex *a, integer *
		   lda, real *work);

doublereal clangt_(char *norm, integer *n, singlecomplex *dl, singlecomplex *d__, singlecomplex 
		   *du);

doublereal clanhb_(char *norm, char *uplo, integer *n, integer *k, singlecomplex *
		   ab, integer *ldab, real *work);

doublereal clanhe_(char *norm, char *uplo, integer *n, singlecomplex *a, integer *
		   lda, real *work);

doublereal clanhf_(char *norm, char *transr, char *uplo, integer *n, singlecomplex *
		   a, real *work);

doublereal clanhp_(char *norm, char *uplo, integer *n, singlecomplex *ap, real *
		   work);

doublereal clanhs_(char *norm, integer *n, singlecomplex *a, integer *lda, real *
		   work);

doublereal clanht_(char *norm, integer *n, real *d__, singlecomplex *e);

doublereal clansb_(char *norm, char *uplo, integer *n, integer *k, singlecomplex *
		   ab, integer *ldab, real *work);

doublereal clansp_(char *norm, char *uplo, integer *n, singlecomplex *ap, real *
		   work);

doublereal clansy_(char *norm, char *uplo, integer *n, singlecomplex *a, integer *
		   lda, real *work);

doublereal clantb_(char *norm, char *uplo, char *diag, integer *n, integer *k, 
		   singlecomplex *ab, integer *ldab, real *work);

doublereal clantp_(char *norm, char *uplo, char *diag, integer *n, singlecomplex *
		   ap, real *work);

doublereal clantr_(char *norm, char *uplo, char *diag, integer *m, integer *n, 
		   singlecomplex *a, integer *lda, real *work);

/* Subroutine */ int clapll_(integer *n, singlecomplex *x, integer *incx, singlecomplex *
			     y, integer *incy, real *ssmin);

/* Subroutine */ int clapmt_(logical *forwrd, integer *m, integer *n, singlecomplex 
...
/* Subroutine */ int claqp2_(integer *m, integer *n, integer *offset, singlecomplex 
			     *a, integer *lda, integer *jpvt, singlecomplex *tau, real *vn1, real *vn2, 
			     singlecomplex *work);

/* Subroutine */ int claqps_(integer *m, integer *n, integer *offset, integer 
			     *nb, integer *kb, singlecomplex *a, integer *lda, integer *jpvt, singlecomplex *
			     tau, real *vn1, real *vn2, singlecomplex *auxv, singlecomplex *f, integer *ldf);
...
/* Subroutine */ int clar1v_(integer *n, integer *b1, integer *bn, real *
			     ...
			     gaptol, singlecomplex *z__, logical *wantnc, integer *negcnt, real *ztz, 
...
/* Subroutine */ int clarfp_(integer *n, singlecomplex *alpha, singlecomplex *x, integer *
			     incx, singlecomplex *tau);
...
/* Subroutine */ int clargv_(integer *n, singlecomplex *x, integer *incx, singlecomplex *
...
/* Subroutine */ int clarrv_(integer *n, real *vl, real *vu, real *d__, real *
			     ...
			     real *wgap, integer *iblock, integer *indexw, real *gers, singlecomplex *
...
/* Subroutine */ int clartv_(integer *n, singlecomplex *x, integer *incx, singlecomplex *
			     y, integer *incy, real *c__, singlecomplex *s, integer *incc);
...
/* Subroutine */ int clarzb_(char *side, char *trans, char *direct, char *
			     storev, integer *m, integer *n, integer *k, integer *l, singlecomplex *v, 
...
/* Subroutine */ int clatbs_(char *uplo, char *trans, char *diag, char *
			     normin, integer *n, integer *kd, singlecomplex *ab, integer *ldab, singlecomplex *
			     x, real *scale, real *cnorm, integer *info);

/* Subroutine */ int clatdf_(integer *ijob, integer *n, singlecomplex *z__, integer 
			     *ldz, singlecomplex *rhs, real *rdsum, real *rdscal, integer *ipiv, integer 
			     *jpiv);

/* Subroutine */ int clatps_(char *uplo, char *trans, char *diag, char *
			     normin, integer *n, singlecomplex *ap, singlecomplex *x, real *scale, real *cnorm, 
			     integer *info);
...
/* Subroutine */ int cpbrfs_(char *uplo, integer *n, integer *kd, integer *
			     nrhs, singlecomplex *ab, integer *ldab, singlecomplex *afb, integer *ldafb, 
			     singlecomplex *b, integer *ldb, singlecomplex *x, integer *ldx, real *ferr, real *
			     berr, singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int cpbsv_(char *uplo, integer *n, integer *kd, integer *
			    nrhs, singlecomplex *ab, integer *ldab, singlecomplex *b, integer *ldb, integer *
			    info);

/* Subroutine */ int cpbsvx_(char *fact, char *uplo, integer *n, integer *kd, 
			     integer *nrhs, singlecomplex *ab, integer *ldab, singlecomplex *afb, integer *
			     ldafb, char *equed, real *s, singlecomplex *b, integer *ldb, singlecomplex *x, 
...
/* Subroutine */ int cpftrs_(char *transr, char *uplo, integer *n, integer *
			     nrhs, singlecomplex *a, singlecomplex *b, integer *ldb, integer *info);
...
/* Subroutine */ int cporfs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, singlecomplex *af, integer *ldaf, singlecomplex *b, integer *ldb, 
...
/* Subroutine */ int cporfsx_(char *uplo, char *equed, integer *n, integer *
			      nrhs, singlecomplex *a, integer *lda, singlecomplex *af, integer *ldaf, real *s, 
			      singlecomplex *b, integer *ldb, singlecomplex *x, integer *ldx, real *rcond, real 
			      *berr, integer *n_err_bnds__, real *err_bnds_norm__, real *
			      err_bnds_comp__, integer *nparams, real *params, singlecomplex *work, real *
			      rwork, integer *info);
...
/* Subroutine */ int cposvx_(char *fact, char *uplo, integer *n, integer *
			     nrhs, singlecomplex *a, integer *lda, singlecomplex *af, integer *ldaf, char *
			     equed, real *s, singlecomplex *b, integer *ldb, singlecomplex *x, integer *ldx, 
...
/* Subroutine */ int cpprfs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     ap, singlecomplex *afp, singlecomplex *b, integer *ldb, singlecomplex *x, integer *ldx, 
			     real *ferr, real *berr, singlecomplex *work, real *rwork, integer *info);

/* Subroutine */ int cppsv_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			    ap, singlecomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cppsvx_(char *fact, char *uplo, integer *n, integer *
			     nrhs, singlecomplex *ap, singlecomplex *afp, char *equed, real *s, singlecomplex *b, 
			     integer *ldb, singlecomplex *x, integer *ldx, real *rcond, real *ferr, real 
			     *berr, singlecomplex *work, real *rwork, integer *info);

/* Subroutine */ int cpptrf_(char *uplo, integer *n, singlecomplex *ap, integer *
			     info);

/* Subroutine */ int cpptri_(char *uplo, integer *n, singlecomplex *ap, integer *
			     info);

/* Subroutine */ int cpptrs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     ap, singlecomplex *b, integer *ldb, integer *info);
...
/* Subroutine */ int cptrfs_(char *uplo, integer *n, integer *nrhs, real *d__, 
			     singlecomplex *e, real *df, singlecomplex *ef, singlecomplex *b, integer *ldb, singlecomplex 
			     *x, integer *ldx, real *ferr, real *berr, singlecomplex *work, real *rwork, 
			     integer *info);
...
/* Subroutine */ int cptsvx_(char *fact, integer *n, integer *nrhs, real *d__, 
			     singlecomplex *e, real *df, singlecomplex *ef, singlecomplex *b, integer *ldb, singlecomplex 
			     *x, integer *ldx, real *rcond, real *ferr, real *berr, singlecomplex *work, 
			     real *rwork, integer *info);
...
/* Subroutine */ int cptts2_(integer *iuplo, integer *n, integer *nrhs, real *
			     d__, singlecomplex *e, singlecomplex *b, integer *ldb);

/* Subroutine */ int crot_(integer *n, singlecomplex *cx, integer *incx, singlecomplex *
			   cy, integer *incy, real *c__, singlecomplex *s);

/* Subroutine */ int cspcon_(char *uplo, integer *n, singlecomplex *ap, integer *
			     ipiv, real *anorm, real *rcond, singlecomplex *work, integer *info);

/* Subroutine */ int cspmv_(char *uplo, integer *n, singlecomplex *alpha, singlecomplex *
			    ap, singlecomplex *x, integer *incx, singlecomplex *beta, singlecomplex *y, integer *
			    incy);
...
/* Subroutine */ int csprfs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     ap, singlecomplex *afp, integer *ipiv, singlecomplex *b, integer *ldb, singlecomplex *x, 
			     integer *ldx, real *ferr, real *berr, singlecomplex *work, real *rwork, 
			     integer *info);

/* Subroutine */ int cspsv_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			    ap, integer *ipiv, singlecomplex *b, integer *ldb, integer *info);
...
/* Subroutine */ int csptrf_(char *uplo, integer *n, singlecomplex *ap, integer *
			     ipiv, integer *info);

/* Subroutine */ int csptri_(char *uplo, integer *n, singlecomplex *ap, integer *
			     ipiv, singlecomplex *work, integer *info);

/* Subroutine */ int csptrs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     ap, integer *ipiv, singlecomplex *b, integer *ldb, integer *info);
...
/* Subroutine */ int cstein_(integer *n, real *d__, real *e, integer *m, real 
			     *w, integer *iblock, integer *isplit, singlecomplex *z__, integer *ldz, 
...
/* Subroutine */ int csyequb_(char *uplo, integer *n, singlecomplex *a, integer *
			      lda, real *s, real *scond, real *amax, singlecomplex *work, integer *info);

/* Subroutine */ int csymv_(char *uplo, integer *n, singlecomplex *alpha, singlecomplex *
			    a, integer *lda, singlecomplex *x, integer *incx, singlecomplex *beta, singlecomplex *y, 
			    integer *incy);
...
/* Subroutine */ int csyrfs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, singlecomplex *af, integer *ldaf, integer *ipiv, singlecomplex *
			     b, integer *ldb, singlecomplex *x, integer *ldx, real *ferr, real *berr, 
			     singlecomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int csytrs_(char *uplo, integer *n, integer *nrhs, singlecomplex *
			     a, integer *lda, integer *ipiv, singlecomplex *b, integer *ldb, integer *
			     info);
...
/* Subroutine */ int ctfttp_(char *transr, char *uplo, integer *n, singlecomplex *
			     arf, singlecomplex *ap, integer *info);

/* Subroutine */ int ctfttr_(char *transr, char *uplo, integer *n, singlecomplex *
			     arf, singlecomplex *a, integer *lda, integer *info);
...
/* Subroutine */ int ctgexc_(logical *wantq, logical *wantz, integer *n, 
			     singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, singlecomplex *q, 
			     integer *ldq, singlecomplex *z__, integer *ldz, integer *ifst, integer *
			     ilst, integer *info);
...
/* Subroutine */ int ctgsen_(integer *ijob, logical *wantq, logical *wantz, 
			     ...
			     singlecomplex *z__, integer *ldz, integer *m, real *pl, real *pr, real *
			     dif, singlecomplex *work, integer *lwork, integer *iwork, integer *liwork, 
			     integer *info);

/* Subroutine */ int ctgsja_(char *jobu, char *jobv, char *jobq, integer *m, 
			     integer *p, integer *n, integer *k, integer *l, singlecomplex *a, integer *
			     lda, singlecomplex *b, integer *ldb, real *tola, real *tolb, real *alpha, 
			     real *beta, singlecomplex *u, integer *ldu, singlecomplex *v, integer *ldv, 
			     singlecomplex *q, integer *ldq, singlecomplex *work, integer *ncycle, integer *
			     info);
...
/* Subroutine */ int ctgsna_(char *job, char *howmny, logical *select, 
			     ...
			     singlecomplex *vl, integer *ldvl, singlecomplex *vr, integer *ldvr, real *s, real 
			     *dif, integer *mm, integer *m, singlecomplex *work, integer *lwork, integer 
			     *iwork, integer *info);

/* Subroutine */ int ctgsy2_(char *trans, integer *ijob, integer *m, integer *
			     n, singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, singlecomplex *c__, 
...
/* Subroutine */ int ctpttf_(char *transr, char *uplo, integer *n, singlecomplex *
			     ap, singlecomplex *arf, integer *info);
...
/* Subroutine */ int ctrrfs_(char *uplo, char *trans, char *diag, integer *n, 
			     ...
			     singlecomplex *x, integer *ldx, real *ferr, real *berr, singlecomplex *work, real 
			     *rwork, integer *info);

/* Subroutine */ int ctrsen_(char *job, char *compq, logical *select, integer 
			     *n, singlecomplex *t, integer *ldt, singlecomplex *q, integer *ldq, singlecomplex *w, 
			     integer *m, real *s, real *sep, singlecomplex *work, integer *lwork, 
			     integer *info);

/* Subroutine */ int ctrsna_(char *job, char *howmny, logical *select, 
			     integer *n, singlecomplex *t, integer *ldt, singlecomplex *vl, integer *ldvl, 
			     singlecomplex *vr, integer *ldvr, real *s, real *sep, integer *mm, integer *
			     m, singlecomplex *work, integer *ldwork, real *rwork, integer *info);

/* Subroutine */ int ctrsyl_(char *trana, char *tranb, integer *isgn, integer 
			     *m, integer *n, singlecomplex *a, integer *lda, singlecomplex *b, integer *ldb, 
...
/* Subroutine */ int cupgtr_(char *uplo, integer *n, singlecomplex *ap, singlecomplex *
			     tau, singlecomplex *q, integer *ldq, singlecomplex *work, integer *info);
